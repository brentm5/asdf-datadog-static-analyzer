...
# NOTE: You might want to remove this if datadog-static-analyzer is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if datadog-static-analyzer has other means of determining installable versions.
	list_github_tags
}
